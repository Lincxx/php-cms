...
<?php include 'includes/header.php';?>
    ...
    <!-- Navigation -->
<?php include 'includes/navigatioin.php'?>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <?php
                if(isset($_POST['create_comment'])){
                    ...
                    if($comment_author != "" && $comment_email != ""){
                        ...
                        $add_one_post_comment_count_query = "UPDATE posts SET post_comment_count = post_comment_count + 1 where post_id = $pid";
                        $add_one_post_comment_count = mysqli_query($connection, $add_one_post_comment_count_query);
                    } else {
            ...
            <!-- Posted Comments -->
            <?php //Display all the approved comments;
